...
$siteInfo = [
	//general info
	"company_name" => "Morisset Construction",
	"phone" => "604.346.7592", 		  //either no format or dashed format
	"email" => "jt@morissetconstruction.com",   //by default is used as recipient email  
	"address" => "Complexe Jules-Dallaire, 2828 Boulvard Laurier Tower 1, 7th floor 705, Québec, QC G1V 0B9, Canada",
